...
<a target="_blank" href="https://studio.apollographql.com/sandbox/explorer?endpoint=${process.env.HOSTNAME}/graphql&document=query manufacturers{manufacturers{ id }}"> Apollo explorer </a> 
