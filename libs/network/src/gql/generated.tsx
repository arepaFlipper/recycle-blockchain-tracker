...
export type ExampleQueryQuery = { __typename?: 'Query', manufacturers: Array<{ __typename?: 'Manufacturer', id: string, name: string, location: string, contact: string }> };
