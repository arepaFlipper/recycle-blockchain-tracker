...
const variantColor = {
  contained: {
    primary: 'text-white bg-[#181825] border-2 border-black hover:opacity-80',
...
export const Button = ({
  ...
  return (
    <button
      ...
      className={` text-white border-white  relative rounded font-medium ${sizeCls} ${fwCls} ${variantCls} ${disCls}  ${className} `}
      {...props}
    >
      {loading ? (
        <>
